...
export interface ApiProfessionalRoleProfessionalRole
  extends Struct.CollectionTypeSchema {
  collectionName: 'professional_roles';
  info: {
    displayName: 'Professional Role';
    pluralName: 'professional-roles';
    singularName: 'professional-role';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    Accomplishments: Schema.Attribute.Component<'cms-content.list', true> &
    ...
    Company: Schema.Attribute.Component<'cms-content.organization', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    Skills: Schema.Attribute.Component<'cms-content.list', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
